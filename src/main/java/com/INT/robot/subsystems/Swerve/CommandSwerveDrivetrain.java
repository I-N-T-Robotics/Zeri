...
import com.INT.robot.constants.Gains;
import com.INT.robot.constants.Settings;
import com.INT.robot.subsystems.Swerve.TunerConstants.TunerSwerveDrivetrain;
...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("Turret/Dist From Hub", turretPose.getTranslation().getDistance(Field.hubCenter));
        SmartDashboard.putNumber("InterpolationTesting/Turret Dist From Hub", turretPose.getTranslation().getDistance(Field.hubCenter));
        ...
        SmartDashboard.putNumber("Swerve/Distance From Hub (meters)", Field.hubCenter.getDistance(getPose().getTranslation()));
        }
}